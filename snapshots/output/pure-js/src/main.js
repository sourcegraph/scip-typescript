...
//                 ^ definition scip-typescript npm pure-js 1.0.0 src/`main.js`/print_fib().(a)
  console.log(fib(a))
//^^^^^^^ reference scip-typescript npm typescript 5.3.3 lib/`lib.dom.d.ts`/console.
//^^^^^^^ reference scip-typescript npm @types/node 20.10.5 `globals.d.ts`/global/console.
//^^^^^^^ reference scip-typescript npm @types/node 20.10.5 `console.d.ts`/`"node:console"`/global/console/
//^^^^^^^ reference scip-typescript npm @types/node 20.10.5 `console.d.ts`/`"node:console"`/global/console.
//        ^^^ reference scip-typescript npm typescript 5.3.3 lib/`lib.dom.d.ts`/Console#log().
//        ^^^ reference scip-typescript npm @types/node 20.10.5 `console.d.ts`/`"node:console"`/global/Console#log().
//            ^^^ reference scip-typescript npm pure-js 1.0.0 src/`main.js`/fib().
