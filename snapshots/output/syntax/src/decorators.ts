...
//                 ^^^^^^ definition local 2
//                         ^^^^^^^^ reference typescript 5.7.3 lib/`lib.es5.d.ts`/Function#
//                         ^^^^^^^^ reference typescript 5.7.3 lib/`lib.es5.d.ts`/Function.
//                         ^^^^^^^^ reference typescript 5.7.3 lib/`lib.es2015.core.d.ts`/Function#
//                         ^^^^^^^^ reference typescript 5.7.3 lib/`lib.es2015.symbol.wellknown.d.ts`/Function#
    console.log(`MyDecorator is called with value: ${value}`)
//  ^^^^^^^ reference typescript 5.7.3 lib/`lib.dom.d.ts`/console.
...
//  ^^^^^^^ reference @types/node 20.16.10 `console.d.ts`/`"node:console"`/global/console.
//          ^^^ reference typescript 5.7.3 lib/`lib.dom.d.ts`/Console#log().
