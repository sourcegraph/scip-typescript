...
//       ^^^^^^ definition scip-typescript npm syntax 1.0.0 src/`infer-relationship.ts`/random().
  return Math.random()
//       ^^^^ reference scip-typescript npm typescript 4.8.4 lib/`lib.es5.d.ts`/Math#
//       ^^^^ reference scip-typescript npm typescript 4.8.4 lib/`lib.es5.d.ts`/Math.
//       ^^^^ reference scip-typescript npm typescript 4.8.4 lib/`lib.es2015.core.d.ts`/Math#
//       ^^^^ reference scip-typescript npm typescript 4.8.4 lib/`lib.es2015.symbol.wellknown.d.ts`/Math#
//            ^^^^^^ reference scip-typescript npm typescript 4.8.4 lib/`lib.es5.d.ts`/Math#random().
}
...
//      ^^^^^^ reference scip-typescript npm syntax 1.0.0 src/`infer-relationship.ts`/random().
//                 ^^^^^^ reference scip-typescript npm typescript 4.8.4 lib/`lib.es5.d.ts`/Number#
//                 ^^^^^^ reference scip-typescript npm typescript 4.8.4 lib/`lib.es5.d.ts`/Number.
//                 ^^^^^^ reference scip-typescript npm typescript 4.8.4 lib/`lib.es5.d.ts`/Number#
//                 ^^^^^^ reference scip-typescript npm typescript 4.8.4 lib/`lib.es2020.number.d.ts`/Number#
//                        ^^^^^^^^ reference scip-typescript npm typescript 4.8.4 lib/`lib.es2015.core.d.ts`/NumberConstructor#parseInt().
//                                 ^ reference local 8
      return {
        property: 41,
...
//           ^^^ reference scip-typescript npm typescript 4.8.4 lib/`lib.es5.d.ts`/Array#map().
//               ^^^^^^^^^^^^^ reference scip-typescript npm syntax 1.0.0 src/`infer-relationship.ts`/Configuration#
//                              ^^^^^^ definition local 12
