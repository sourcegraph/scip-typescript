...
//                ^ reference local 12
//                    ^ reference local 8
//                      ^^^^^^ reference scip-typescript npm typescript 4.8.4 lib/`lib.es5.d.ts`/String#length.
//                              ^ reference local 12
    c += d
//  ^ reference local 8
//       ^ reference local 12
...
//        ^ reference local 8
//           ^^ reference local 9
//               ^^^^^^ reference scip-typescript npm typescript 4.8.4 lib/`lib.es5.d.ts`/Array#reduce().
//                       ^^^^^^^^^^^^^ definition local 16
//                                      ^^^^^^^^^^^^ definition local 17
//                                                    ^^^^^^^^^^^^ definition local 18
