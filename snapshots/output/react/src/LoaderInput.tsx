...
//          ^^^^^ reference scip-typescript npm @types/react 17.0.52 `index.d.ts`/React/
//                ^^^^^^^^^ reference scip-typescript npm @types/react 17.0.52 `index.d.ts`/React/ReactNode#
}
...
//^^^^^^^^ reference local 7
  ...
  <div className="hello">
// ^^^ reference scip-typescript npm @types/react 17.0.52 `index.d.ts`/global/JSX/IntrinsicElements#div.
//     ^^^^^^^^^ reference scip-typescript npm @types/react 17.0.52 `index.d.ts`/React/HTMLAttributes#className.
    {children}
//   ^^^^^^^^ reference local 4
    {loading && <p>spinner</p>}
//   ^^^^^^^ reference local 3
//               ^ reference scip-typescript npm @types/react 17.0.52 `index.d.ts`/global/JSX/IntrinsicElements#p.
//                          ^ reference scip-typescript npm @types/react 17.0.52 `index.d.ts`/global/JSX/IntrinsicElements#p.
  </div>
//  ^^^ reference scip-typescript npm @types/react 17.0.52 `index.d.ts`/global/JSX/IntrinsicElements#div.
)
