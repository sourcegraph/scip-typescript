...
export namespace lib.codeintel.lsif_typed {
  ...
  export class Index extends pb_1.Message {
    ...
    static fromObject(data: {
      ...
      external_symbols?: ReturnType<
        typeof SymbolInformation.prototype.toObject
      >[]
    }) {
      ...
      if (data.documents != null) {
        message.documents = data.documents.map(item =>
          Document.fromObject(item)
        )
      }
    ...
    toObject() {
      ...
      if (this.external_symbols != null) {
        data.external_symbols = this.external_symbols.map(
          (item: SymbolInformation) => item.toObject()
        )
      }
      return data
    }
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      ...
      if (this.external_symbols !== undefined)
        writer.writeRepeatedMessage(
          ...
          (item: SymbolInformation) => item.serialize(writer)
        )
  ...
  export class Metadata extends pb_1.Message {
    constructor(
      ...
      if (!Array.isArray(data) && typeof data == 'object') {
        ...
        if (
          'text_document_encoding' in data &&
          data.text_document_encoding != undefined
        ) {
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      const writer = w || new pb_1.BinaryWriter()
      if (this.version !== undefined) writer.writeEnum(1, this.version)
      if (this.tool_info !== undefined)
        writer.writeMessage(2, this.tool_info, () =>
          this.tool_info.serialize(writer)
        )
  ...
  export class Document extends pb_1.Message {
    ...
    static fromObject(data: {
      ...
      if (data.occurrences != null) {
        message.occurrences = data.occurrences.map(item =>
          Occurrence.fromObject(item)
        )
      }
      if (data.symbols != null) {
        message.symbols = data.symbols.map(item =>
          SymbolInformation.fromObject(item)
        )
      }
      return message
    ...
    toObject() {
      ...
      if (this.occurrences != null) {
        data.occurrences = this.occurrences.map((item: Occurrence) =>
          item.toObject()
        )
      }
      if (this.symbols != null) {
        data.symbols = this.symbols.map((item: SymbolInformation) =>
          item.toObject()
        )
      }
      return data
  ...
  export class Symbol extends pb_1.Message {
    ...
    static fromObject(data: {
      ...
      if (data.descriptors != null) {
        message.descriptors = data.descriptors.map(item =>
          Descriptor.fromObject(item)
        )
      }
      return message
    }
    toObject() {
      ...
      if (this.descriptors != null) {
        data.descriptors = this.descriptors.map((item: Descriptor) =>
          item.toObject()
        )
      }
      return data
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      ...
      if (this.package !== undefined)
        writer.writeMessage(2, this.package, () =>
          this.package.serialize(writer)
        )
  ...
  export class Descriptor extends pb_1.Message {
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      ...
      if (this.suffix !== undefined) writer.writeEnum(3, this.suffix)
      if (!w) return writer.getResultBuffer()
    }
  ...
  export class SymbolInformation extends pb_1.Message {
    ...
    static fromObject(data: {
      ...
      if (data.relationships != null) {
        message.relationships = data.relationships.map(item =>
          Relationship.fromObject(item)
        )
      }
      return message
    }
    toObject() {
      ...
      if (this.relationships != null) {
        data.relationships = this.relationships.map((item: Relationship) =>
          item.toObject()
        )
      }
      return data
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      ...
      if (this.relationships !== undefined)
        writer.writeRepeatedMessage(
          4,
          this.relationships,
          (item: Relationship) => item.serialize(writer)
        )
      if (!w) return writer.getResultBuffer()
    }
    static deserialize(
  ...
  export class Relationship extends pb_1.Message {
    constructor(
      ...
      if (!Array.isArray(data) && typeof data == 'object') {
        ...
        if (
          'is_implementation' in data &&
          data.is_implementation != undefined
        ) {
          this.is_implementation = data.is_implementation
        }
        if (
          'is_type_definition' in data &&
          data.is_type_definition != undefined
        ) {
  ...
  export class Occurrence extends pb_1.Message {
    constructor(
      ...
      if (!Array.isArray(data) && typeof data == 'object') {
        ...
        if (
          'override_documentation' in data &&
          data.override_documentation != undefined
        ) {
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      const writer = w || new pb_1.BinaryWriter()
      if (this.range !== undefined) writer.writePackedInt32(1, this.range)
      if (typeof this.symbol === 'string' && this.symbol.length)
      ...
      if (this.syntax_kind !== undefined) writer.writeEnum(5, this.syntax_kind)
      if (!w) return writer.getResultBuffer()
    }
